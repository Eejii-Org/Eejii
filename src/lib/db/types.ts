...
import type { PartnerType, Role, UserType, ProjectType, EventType, RequestStatus, ProjectStatus, PaymentStatus, PermitType, InvoiceStatus } from "./enums";
...
export type Invoice = {
    ...
    itemsTotal: Generated<string>;
    fee: Generated<string>;
    feePercentage: Generated<number>;
