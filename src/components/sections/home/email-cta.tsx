  ...
  return (
    <div className="bg-[#d5e4e5] py-9">
      <div className="container flex flex-col items-center justify-center gap-6">
        <div className="text-[#0C1B1C] text-3xl font-semibold">
          Тогтмол мэдээлэл авах
        </div>
        <div className="font-medium text-lg text-[#0C1B1C] text-center w-3/5">
        ...
        <div className="flex flex-row gap-3">
          <input
            ...
            className="rounded-full px-6 w-80 outline-none"
          />
