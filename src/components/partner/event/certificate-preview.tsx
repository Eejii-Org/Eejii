...
export const EventCertificatePreview = ({
  description,
  shortDescription,
  organizationName,
  logoUrl,
              ...
              <View style={styles.section}>
                ...
                <View style={{ marginTop: 10 }}>
                  ...
                  <Text style={styles.certificateNumber}>
                    The certificate number [certificate number]
                  </Text>
                  <Text style={styles.volunteerNameText}>[volunteer name]</Text>
                  ...
                  <View style={styles.images}>
                    ...
                    >
                      ...
                      />
                      <Text style={styles.smallText}>Scan this</Text>
                    </View>
                    <View
                      style={{
                        height: '70px',
