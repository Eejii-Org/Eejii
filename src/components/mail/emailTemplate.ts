                    ...
                    <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;" width="100%" cellpadding="0"
                      ...
                      <tr>
                        <td class="sm-px-24"
                          ...
                          <p style="font-weight: 600; font-size: 18px; margin-bottom: 0;">${greetins}</p>

                          <p style="margin: 0 0 24px;">
                            ${body}
                          </p>

                          ${label && `<p style="display: block; font-weight: 600; font-size: 32px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #000000; text-decoration: none;">${label}</p>`}
                          ${
                            note &&
                            `
